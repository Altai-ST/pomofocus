...
export const InfoBlock=()=>{
    return(
        <div className='MainBlock'>
            <h1 className='h1'>An online Pomodoro Timer to boost your productivity</h1>
            <div>
            ...
            <div>
                ...
                <div className='liner'></div>
                <ul>
                    <img src={require("../../assets/icons/report.png")} />
                    <li><span className='last'>For macOS</span> (zip file)</li>
                    <li><span className='last'>For Windows</span>(zip file)</li>
                </ul>
            </div>
